...
class _$_LoginModel extends _LoginModel {
  _$_LoginModel({required this.accessToken, required this.refreshToken})
      : super._();
  ...
  @override
  String toString() {
    return 'LoginModel(accessToken: $accessToken, refreshToken: $refreshToken)';
  }
...
abstract class _LoginModel extends LoginModel {
  factory _LoginModel(
      ...
      required final String refreshToken}) = _$_LoginModel;
