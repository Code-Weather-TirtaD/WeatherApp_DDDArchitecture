...
mixin _$LocationModel {
  ...
  String get stateCity => throw _privateConstructorUsedError;
...
abstract class $LocationModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String city, String stateCity, double latitude, double longitude});
}
    ...
    return _then(_value.copyWith(
      city: null == city
          ...
          : city // ignore: cast_nullable_to_non_nullable
              as String,
      stateCity: null == stateCity
          ? _value.stateCity
          : stateCity // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$_LocationModel extends _LocationModel {
  ...
  @override
  String toString() {
    return 'LocationModel(city: $city, stateCity: $stateCity, latitude: $latitude, longitude: $longitude)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.stateCity, stateCity) ||
                other.stateCity == stateCity) &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, city, stateCity, latitude, longitude);
...
abstract class _LocationModel extends LocationModel {
  factory _LocationModel(
      ...
      required final String stateCity,
      required final double latitude,
      required final double longitude}) = _$_LocationModel;
